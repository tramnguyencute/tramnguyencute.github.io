...
## Hi again, my name is Nguyen Duy Bang
  ...
  <a href="tel:{{ site.author.telephone }}" target="_blank" title="Phone">
  ...
  <a href="https://zalo.me/{{ site.author.telephone }}" target="_blank" title="Zalo">
    <span class="fa-stack fa-lg" aria-hidden="true">
      <i class="fa fa-circle fa-stack-2x"></i>
  ...
  <a href="https://m.me/{{ site.author.facebook }} " target="_blank" title="Messenger">
    <span class="fa-stack fa-lg" aria-hidden="true">
      <i class="fa fa-circle fa-stack-2x"></i>
  ...
  <a href="https://linkedin.com/in/{{ site.author.linkedin }}" target="_blank" title="LinkedIn">
  <span class="fa-stack fa-lg" aria-hidden="true">
    <i class="fa fa-circle fa-stack-2x"></i>
  ...
  <a href="https://www.facebook.com/{{ site.author.facebook }}" target="_blank" title="Facebook">
    <span class="fa-stack fa-lg" aria-hidden="true">
      <i class="fa fa-circle fa-stack-2x"></i>
  ...
  <a href="mailto:{{ site.author.email }}" target="_blank" title="Email me">
    <span class="fa-stack fa-lg" aria-hidden="true">
      <i class="fa fa-circle fa-stack-2x"></i>
  ...
  <a href="https://www.instagram.com/{{ site.author.instagram }}" target="_blank" title="Instagram">
    <span class="fa-stack fa-lg" aria-hidden="true">
      <i class="fa fa-circle fa-stack-2x"></i>
  ...
  <a href="https://www.youtube.com/{{ site.author.youtube }}" target="_blank" title="YouTube">
    <span class="fa-stack fa-lg" aria-hidden="true">
      <i class="fa fa-circle fa-stack-2x"></i>
  ...
  <a href="https://nhantien.momo.vn/{{ site.author.telephone }}" target="_blank" title="MoMo">
    <span class="fa-stack fa-lg" aria-hidden="true">
      <i class="fa fa-circle fa-stack-2x"></i>
